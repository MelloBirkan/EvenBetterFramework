...
1. `$eb-epic 7-execute` — begin implementation of the tickets (required next step)
2. `$eb-epic 10-cross-artifact-validation` — validate consistency across all specs and tickets before executing (optional intermediate step)
