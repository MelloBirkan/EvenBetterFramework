...
1. `$eb-epic 6-ticket-breakdown` — break the plan into implementation tickets (required next step)
2. `$eb-epic 5-architecture-validation` — stress-test the architecture before committing to implementation (optional intermediate step)
