...
Emit a single JSON object on stdout in `full` mode:
...
The final response must contain only the JSON object. Do not wrap it in Markdown fences, add commentary, or include partial diagnostic output.
